...
// have to look into a simple logger or make my own
...
const dockerImageName = `${username}/nest-mqtt-bridge:v${version}`;
const dockerImageNameLatest = `${username}/nest-mqtt-bridge:latest`;
